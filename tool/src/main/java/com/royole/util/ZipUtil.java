...
public class ZipUtil {
     ...
     * @return
     */
    public static boolean isZip64EndOfCentralDirectoryLocatorPresent(RandomAccessFile zip, long zipEndOfCentralDirectoryPosition) {
     ...
     * @throws IOException
     */
     static Pair<ByteBuffer, Long> findZipEndOfCentralDirectoryRecord(RandomAccessFile apk) throws IOException {
    ...
    /**
     * @param apk
     * The apk file need to find EoCD record
     *
     * @param maxCommentSize
     * The max accepted size of EoCD comment field.The permitted value is from 0 to 65535 inclusive.
     ...
     * @throws IOException
     */
    static Pair<ByteBuffer, Long> findZipEndOfCentralDirectoryRecord(RandomAccessFile apk, int maxCommentSize) throws IOException {
     ...
     *
     * @return
     * offset of EoCD in apk file,it returns -1 when the EoCD field not found
     *
     * @throws IOException
     */
    static int findZipEndOfCentralDirectoryRecord(ByteBuffer eocdContents) throws IOException{
